...
grumphouse is derived from the TT1 Blocks theme, Copyright (c) 2020 WordPress.org. 
...
grumphouse bundles the following third-party resources:
...
Included as part of:
	- grumphouse_get_google_fonts_url(), for building a Google Fonts request URL from fonts set in theme.json

== Special Thanks ==

To theme.json trailblazers helping grumphouse find her way, including:
...
-------------------------
- Updated grumphouse to use local fonts with the new fontFamily theme.json setting. This replaces the old PHP based Google Fonts solution.
...
- Gutenberg 12.1:
	...
	- Updated header and footer template patterns to work with new Core markup structure and grumphouse styles.
...
-------------------------
- Gutenberg 11.8:
	- grumphouse_setup(): Removed add_theme_support() calls no longer needed thanks to Gutenberg updates.
