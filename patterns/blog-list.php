<?php
/**
 * Title: List with featured image, title, excerpt, and post date.
 * Slug: grumphouse/blog-list
 * Categories: grumphouse-blog
 */
?>
...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-query alignwide">
		...
		<!-- wp:group {"layout":{"inherit":true}} -->
		<div class="wp-block-group">
			<!-- wp:query-pagination {"paginationArrow":"arrow","align":"wide","className":"alignwide is-style-grumphouse-vertical-separators","layout":{"type":"flex","justifyContent":"space-between"}} -->
