 ...
 * Slug: grumphouse/general-follow-us-vertical
 * Categories: grumphouse-general
 */
?>
<!-- wp:group {"backgroundColor":"senary","className":"is-style-grumphouse-shaded"} -->
<div class="wp-block-group is-style-grumphouse-shaded has-senary-background-color has-background">
